...
---- QUERY DATA
--- a. Exiba todos os municípios em ordem alfabética, juntamente com seus estados e regiões.
SELECT municipio.nome AS municipio, estado.nome AS estado, regiao.nome AS regiao
FROM municipio
